...
import com.feng.system.util.Encryption;
...
//		
	...
	public void initCredentialsMatcher() {
		HashedCredentialsMatcher matcher = new HashedCredentialsMatcher(Encryption.HASH_ALGORITHM);
		matcher.setHashIterations(Encryption.HASH_INTERATIONS);
